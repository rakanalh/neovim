...
function M.apply(colors, opts)
  ...
  -- File status - Colored by status for better visual hierarchy
  hl(0, "NeogitChangeModified", { fg = colors.blue, bg = "NONE" })
  hl(0, "NeogitChangeAdded", { fg = colors.green, bg = "NONE" })
  hl(0, "NeogitChangeDeleted", { fg = colors.red, bg = "NONE" })
  hl(0, "NeogitChangeRenamed", { fg = colors.violet, bg = "NONE" })
  hl(0, "NeogitChangeCopied", { fg = colors.cyan, bg = "NONE" })
  hl(0, "NeogitChangeUpdated", { fg = colors.orange, bg = "NONE" })
  hl(0, "NeogitChangeNewFile", { fg = colors.green, bg = "NONE" })
  hl(0, "NeogitChangeBothModified", { fg = colors.orange, bg = "NONE" })
